...
\begin{aligned}
  ...
  \right) \\
  &= 1 + F_X(x-c_0) - F_X(x+c_0) 
  &\text{for } X \sim \Nd(0,\sqrt{t}) \\
  &= 1 + \frac{1}{2} \left(1  + \erf \left( \frac{x - c_0}{\sqrt{2t}} \right) \right)
   - \frac{1}{2} \left(1  + \erf \left( \frac{x + c_0}{\sqrt{2t}} \right) \right) \\
  &= 1 + \frac{1}{2} \left(\erf \left( \frac{x - c_0}{\sqrt{2t}} \right) - \erf \left( \frac{x + c_0}{\sqrt{2t}} \right) \right)
\end{aligned}
$$
